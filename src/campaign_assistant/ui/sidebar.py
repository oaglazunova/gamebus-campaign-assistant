...
def _render_download_credentials(settings: dict[str, Any]) -> None:
...
def _render_report_download(result: dict[str, Any] | None) -> None:
...
def render_sidebar() -> Dict[str, Any]:
    ...
    with st.sidebar:
        ...
        if source_mode == "Download from GameBus":
            _render_download_credentials(settings)
